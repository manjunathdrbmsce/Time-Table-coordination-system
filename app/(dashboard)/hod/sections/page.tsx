    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">
          View timetables for your department sections in {activeSession.name}
        </p>
      </div>
        ...
        {semesters.map((semester) => (
          <Card key={semester.id}>
            <CardHeader>
              ...
              <CardDescription>{semester.sections.length} sections</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {semester.sections.map((section) => {
                  ...
                  return (
                    <Link key={section.id} href={`/hod/sections/${section.id}`}>
